...
router.get("/user-trips", auth(UserRole.USER), TripControllers.fetchUserAllTrips);
router.get("/pending-approvals", auth(UserRole.MODERATOR, UserRole.ADMIN), TripControllers.fetchTripsForApproval);
...
router.post("/update-status", auth(UserRole.MODERATOR, UserRole.ADMIN), TripControllers.updateStatus);
router.get("/reviewable-trips/:adminId", auth(UserRole.USER, UserRole.MODERATOR), TripControllers.reviewableTrips);
...
router.post("/upload-image", multerUpload.single("file"), TripControllers.uploadImage);
