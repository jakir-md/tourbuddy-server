...
router.get("/user-trips", (0, auth_1.auth)(client_1.UserRole.USER), trip_controller_1.TripControllers.fetchUserAllTrips);
...
router.post("/reviews", (0, auth_1.auth)(client_1.UserRole.USER), trip_controller_1.TripControllers.postReview);
...
router.get("/user-analytics", (0, auth_1.auth)(client_1.UserRole.USER), trip_controller_1.TripControllers.userAnalytics);
router.get("/reviews/:id", (0, auth_1.auth)(client_1.UserRole.USER, client_1.UserRole.MODERATOR), trip_controller_1.TripControllers.allReviews);
