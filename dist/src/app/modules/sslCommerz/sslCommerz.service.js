...
const sslPaymentInit = (payload) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const data = {
            ...
            success_url: `${env_1.EnvVars.SSL_SUCCESS_BACKEND_URL}?transactionId=${payload.transactionId}&amount=${payload.amount}&email=${payload.email}&status=success`,
            fail_url: `${env_1.EnvVars.SSL_FAIL_BACKEND_URL}?transactionId=${payload.transactionId}&amount=${payload.amount}&email=${payload.email}&status=fail`,
            cancel_url: `${env_1.EnvVars.SSL_CANCEL_BACKEND_URL}?transactionId=${payload.transactionId}&amount=${payload.amount}&email=${payload.email}&status=cancel`,
            ipn_url: env_1.EnvVars.SSL_IPN_URL,
